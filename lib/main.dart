...
class _MyWidgetState extends flFramework.State<MyWidget> {
  ...
  Future<void> example1() async {
    ...
    printC('\nExample 1 decode and verify a JWS');
    ...
    printC('content of jws: ${payload.stringContent}');
    printC('protected parameters: ${payload.protectedHeader!.toJson()}');
    ...
    printC('signature verified: $verified');
  }
...
// decode and decrypt a JWE
  Future<void> example3() async {
    ...
    printC('\nExample 3 decode and decrypt a JWE');
    ...
    printC('decrypted content: ${payload.stringContent}');
  }

// create a JWE
  Future<void> example4() async {

    printC('\nExample 4 create a JWE');
...
// generate a key for use with ES256 signing
  Future<void> example8() async {
    ...
    printC('\nExample 8 generate an EC key for use with ES256 signing');

    var alg = JsonWebAlgorithm.getByName('ES256');

    var key = alg.generateRandomKey();
    printC(JsonEncoder.withIndent(' ').convert(key));
    ...
    // convert to PEM
    String ecPrivateKeyPem = key.toString();
    printC('ecPrivateKeyPem: ' + ecPrivateKeyPem);
  }

  String getJwtRS512PrivateKey() {
    return '''-----BEGIN RSA PRIVATE KEY-----
    
    ...
    
    -----END RSA PRIVATE KEY-----''';
  }

  String getJwtRS512PublicKey() {
    return '''ssh-rsa  rbellens@madrid-2.local''';
  }
